...
class QuestionViewSet(ModelViewSet):
    ...
    @action(detail=True, methods=['post'], url_path='answer', url_name='answer_question', serializer_class=AnswerSerializer, permission_classes=[CanAnswerQuestion])
    ...
    @action(detail=False, url_path='preview', url_name='questions_preview', permission_classes=[], serializer_class=QuestionPreviewSerializer)
